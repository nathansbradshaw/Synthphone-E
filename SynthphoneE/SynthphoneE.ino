...
// 'Synthphone', 128x32px
const unsigned char epd_bitmap_SynthpnoneE[] PROGMEM = {
...
void setup()
{
  ...
  display.drawBitmap(0, 0, epd_bitmap_SynthpnoneE, 128, 32, 1);
  display.display();
  delay(2000); // Pause for 2 seconds

  // Clear the buffer
  //TODO:print the defualts
...
void DrawSynthValues(char *display_note, char *display_key, char *display_mode, int display_octave, int display_volume)
{
  display.clearDisplay();
  //draw the blank background
  display.drawBitmap(0, 0, epd_bitmap_SynthphoneE_MenuBlank, 128, 32, 1);
  display.display();

  //set cursur to the key
  display.setCursor(int16_t x17, int16_t y0);
